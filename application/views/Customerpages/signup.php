          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ul class="header-top-right text-right">
                ...
                <li class="account"><a href="login">Sign-up</a></li>
                ...
                <div class="panel-body">
                  <div class="row">
                      ...
                      <?php if($this->session->flashdata('status')):?>
                        <div class="alert alert-success alert-dismissible text-center form-control" id="hide">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                        <i class="icon fa fa-cheack"></i> <?= $this->session->flashdata('status');?>
                        </div>
                    <?php  endif; ?> 
                    <form class="" id="" action="<?php echo base_url('My_controller/signup_customer')?>" method="POST">
                    <div class="form-group ">
                        ...
                        <div class="form-group">
                          <input type="text" name="fullname" id="fullname" value= "<?php echo set_value('fullname');?>" tabindex="1" class="form-control" placeholder="Full Name" value="">
                        ...
                        <div class="form-group">
                           <input type="number" name="age" id="age" value= "<?php echo set_value('age');?>" tabindex="1" class="form-control" placeholder="Age" value="">
                           <span class="text-danger"><?php echo form_error('age');?></span>
                        </div>
                        <div class="form-group">
                          <input type="number" name="mobile_number" id="mobile_number" value= "<?php echo set_value('mobile_number');?>" tabindex="2" class="form-control" placeholder="Mobile No">
                           <span class="text-danger"><?php echo form_error('mobile_number')?></span>
                        </div>
                        <div class="form-group">
                          <input type="email" name="email" id="email" value= "<?php echo set_value('email');?>" tabindex="2" class="form-control" placeholder="email">
