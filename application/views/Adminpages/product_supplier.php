  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            <a href="<?=base_url('My_controller/display_supplier')?>" class="nav-link  active">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=  base_url('My_controller/addsupplier')?>" method="POST" >
          <div class="card-body ">
            <div class="form-group ">
              <label >Supplier_Name</label>
              <input type="text" name="s_name" class="form-control"  placeholder="Enter..." required>
            </div>
          </div>
          <!-- /.card-body -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header  text-center" style="background-color:#335f8f!important">
        <h3 class="modal-title  text-white" id="">EDIT SUPPLIER</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body bg-dark">
        <form action="<?= base_url('My_controller/update_supplier')?>" method="POST" >
          <div class="card-body ">
          <div class="form-group ">
            ...
            <div class="form-group ">
              <label >Supplier_Name</label>
              <input type="text" id="s_name" name="s_name" class="form-control"  placeholder="Enter..." required>
            </div>
          </div>
          <!-- /.card-body -->
          <div class="modal-footer">
        ...
        <div class="card-header">
         <div class="btn btn-outline-primary float-right" data-toggle="modal" data-target="#add">
          ...
          <?php
             $flashdata="";
             $unsetflash_data="";
             if($this->session->flashdata('s_status_danger'))
             {
                $flashdata=$this->session->flashdata('s_status_danger');
                $unsetflash_data="s_status_danger";
                $alert_danger = 'class="alert alert-danger alert-dismissible text-center"';
             }else{
                $flashdata=$this->session->flashdata('s_status_success');
                $alert_danger = 'class="alert alert-success alert-dismissible text-center"';
                $unsetflash_data="s_status_success";
             }
          ?>
          <?php if($flashdata){?>
        ...
        <div class="card-body">
          <table id="supplier" class="table table-bordered  table-hover ">
            ...
            <tr class="text-center ">
              ...
              <td ><?= $row->Name?></td>
              <td>
                <button class="btn btn-sm btn-primary editsupplier" data-toggle="modal" data-target="#edit">
                  <span class="fas fa-pencil-alt"></span>
                </button>
                <a href="<?=base_url('My_controller/delete_supplier')?>?Supplier_id=<?=$row->Supplier_id?>" class="btn btn-sm btn-danger">
